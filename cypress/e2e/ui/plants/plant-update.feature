...
# TEST IDS: UI_PLANT_ADMIN_001, UI_PLANT_USER_001
#
# Reuses Malinda's shared plant-form step phrases:
#   When I fill in the plant name {string}
#   When I enter the plant price {string}
#   When I enter the plant quantity {string}
...
Feature: Edit Plant
  ...
  Scenario: UI_PLANT_ADMIN_001 - Admin updates a plant successfully
    ...
    And I fill in the plant name "Updated Rose"
